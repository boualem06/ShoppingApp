...
const Detail = ({ element, size, setSize, number, setNumber, additional, setAddittional, cart, setCart }) => {
    ...
    return (
        <div style={{ height: "100%" }} className='h-full flex flex-col'>

            <NavbarResp cart={cart}></NavbarResp>
            <div className="flex-grow grid gap-2 md:gap-20 grid-cols-1 md:grid-cols-2 py-2 px-4 lg:px-16 md:px-6 flex flex-col items-center justify-center">
