...
const Menu = () => {
    ...
    return (
        <div className="w-full  md:px-32 lg:px-50 mt-28">
            <h1 className="w-full flex justify-center items-center text-4xl font-bold mb-4 font-lobster">THE   BEST   PIZZA   IN   TOWN</h1>
