    ...
    return (
        <div className="grid gap-4 grid-cols-1 md:grid-cols-3   bg-black mt-20 px-4">
            ...
            <div className='grid grid-rows-5 gap-2  py-4'>
                <h1 className='text-center md:text-left text-yellow-500'>
                    FIND OUR RESTAURANTS
                </h1>
                <h1 className='text-center md:text-left text-white'> 1654 R. Don Road #304, NewYORK,85022 (602)867-1010</h1>
                <h1 className='text-center md:text-left text-white'> 2356 K. Laquie Rd #235,NewYORK,85022 (602)867-1010 </h1>
                <h1 className='text-center md:text-left text-white'> 1614 E.Erwin St #104, NewYORK,85022 (602)867-1010 </h1>
                <h1 className='text-center md:text-left text-white'> 1614 W.Caroll st #125 , NewYORK,85022 (602)867-1010 </h1>
            </div>

            <div className='text-center md:text-left grid grid-rows-4 gap-2 py-4 '>
