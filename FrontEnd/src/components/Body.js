...
const Body=()=>{
    return(
        <div className='bg-gradient-to-r from-orange-600 flex flex-col items-center justify-center grid gap-10 md:flex  md:flex-row md:justify-between md:items-center  to-orange-700  text-center px-10 lg:px-40  '>
